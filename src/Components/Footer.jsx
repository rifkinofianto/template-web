        ...
        <div className="mt-2 mx-4">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 transition text-white rounded-md"
            >
              <svg
              ...
              <span>@nofiantorifki</span>
            </a>
          </div>
        </div>
      </div>

      <div className="border-t border-gray-200 md:mt-8 mt-8 py-4 text-center font-bold md:text-xl text-lg">
        <p>
